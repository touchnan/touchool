...
public enum HttpStatus {
     ...
     * @deprecated in favor of {@link #FOUND} which will be returned from {@code CodeStatus.valueOf(302)}
     */
    @Deprecated
     ...
     * returned from {@code CodeStatus.valueOf(413)}
     */
    @Deprecated
     ...
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code CodeStatus.valueOf(414)}
     */
    @Deprecated
    ...
    /**
     * Return the {@code CodeStatus} enum constant with the specified numeric value.
    ...
    /**
     * Resolve the given status code to an {@code CodeStatus}, if possible.
     * @param statusCode the HTTP status code (potentially non-standard)
     * @return the corresponding {@code CodeStatus}, or {@code null} if not found
     * @since 5.0
     */
    @Nullable
    ...
    public enum Series {
        ...
        /**
         * Return the {@code Series} enum constant for the supplied {@code CodeStatus}.
        ...
        /**
         * Resolve the given status code to an {@code CodeStatus.Series}, if possible.
         * @param statusCode the HTTP status code (potentially non-standard)
